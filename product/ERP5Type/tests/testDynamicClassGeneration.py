...
def test_suite():
  ...
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestZodbPropertySheet))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestZodbModuleComponent))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestZodbExtensionComponent))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestZodbDocumentComponent))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestZodbToolComponent))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestZodbTestComponent))
